              ...
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li className="flex items-center">
                    ...
                    <a href="tel:+14252868699" className="text-gray-300 hover:text-white">425 286 8699</a>
                  </li>
                  <li className="flex items-center">
                    ...
                    <a href="https://wa.me/14252868699" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">425 286 8699</a>
                  </li>
                  <li className="flex items-center">
